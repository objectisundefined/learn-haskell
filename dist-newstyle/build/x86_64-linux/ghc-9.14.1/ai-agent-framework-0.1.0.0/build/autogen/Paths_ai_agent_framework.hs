...
{-|
Module      : Paths_ai_agent_framework
...
-- at runtime using the environment variable ai_agent_framework_bindir.
...
-- environment variable ai_agent_framework_libdir.
...
-- using the environment variable ai_agent_framework_dynlibdir.
...
-- runtime using the environment variable ai_agent_framework_datadir.
...
-- variable ai_agent_framework_libexedir.
...
-- using the environment variable ai_agent_framework_sysconfdir.
...
libdir     = "/home/runner/.cabal/lib/x86_64-linux-ghc-9.14.1-c6c3/ai-agent-framework-0.1.0.0-inplace"
dynlibdir  = "/home/runner/.cabal/lib/x86_64-linux-ghc-9.14.1-c6c3"
datadir    = "/home/runner/.cabal/share/x86_64-linux-ghc-9.14.1-c6c3/ai-agent-framework-0.1.0.0"
libexecdir = "/home/runner/.cabal/libexec/x86_64-linux-ghc-9.14.1-c6c3/ai-agent-framework-0.1.0.0"
sysconfdir = "/home/runner/.cabal/etc"

getBinDir     = catchIO (getEnv "ai_agent_framework_bindir")     (\_ -> return bindir)
getLibDir     = catchIO (getEnv "ai_agent_framework_libdir")     (\_ -> return libdir)
getDynLibDir  = catchIO (getEnv "ai_agent_framework_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "ai_agent_framework_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "ai_agent_framework_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "ai_agent_framework_sysconfdir") (\_ -> return sysconfdir)
